package com.example.jsoncardealer.constants;

public class FilePath {
    public static final String PATH_SUPPLIERS = "src/main/resources/Files/suppliers.json";
    public static final String PATH_PARTS = "src/main/resources/Files/parts.json";
